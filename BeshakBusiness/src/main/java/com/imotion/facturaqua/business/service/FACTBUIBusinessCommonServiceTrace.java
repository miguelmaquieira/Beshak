...
public interface FACTBUIBusinessCommonServiceTrace {
	...
	*/
	public static long CTE_BUSINESS_SERVICE_DUPLICATED_ITEM_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE
	...
	*/
	public static long CTE_BUSINESS_SERVICE_NULL_PARAMETER_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_1
			| 0x0000000000000002L;
	...
	*/
	public static long CTE_BUSINESS_SERVICE_NULL_ELEMENT_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_1
			| 0x0000000000000003L; 
	...
	*/
	public static long CTE_BUSINESS_SERVICE_UNEXPECTED_ELEMENT_TYPE_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_1
			| 0x0000000000000004L; 
	 ...
	 */
	public static long CTE_BUSINESS_SERVICE_UNEXPECTED_PARAM_VALUE_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
	...
	public static long CTE_BUSINESS_SERVICE_METHOD_START_TRACE = 
			FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
	...
	*/
	public static long CTE_BUSINESS_SERVICE_NO_ITEMS_FOUND_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
	...
	*/
	public static long CTE_BUSINESS_SERVICE_NUMBER_OF_RESULTS_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_4  
			| 0x0000000000000002L;	
	
	/**
	 *  Message : The execution of the service {0}, method {1} has saved new item of type {2} with this id:  {3}. 
	 */
	public static long CTE_BUSINESS_SERVICE_ITEM_CREATED_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_4  
			| 0x0000000000000003L;
	 ...
	 */
	public static long CTE_BUSINESS_SERVICE_ITEM_REMOVED_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_4  
			| 0x0000000000000004L;
	 ...
	 */
	public static long CTE_BUSINESS_SERVICE_ITEM_RECOVERED_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_4  
			| 0x0000000000000005L;
	...
	/**
	 *  Message : HosteneoBusinessServiceBase, method -{0}- new tag created with this name : {1}. 
	 */
	 ...
	 */
	public static long CTE_BUSINESS_SERVICE_CURRENT_ITEM_TRACE = FACTBUIBusinessCommonServiceConstant.CTE_BUSINESS_SERVICE_COMMON_RANGE_TRACE 
			| AEMFTITraceConstant.CTE_MFT_AE_CORE_ENVI_TRACE_LEVEL_4  
			| 0x0000000000000009L;
}
