<!doctype html>
<html style="height:100%" xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
	<head>
		<title>Facturaqua, the billing PAAS for water managenment companies</title>
		...
		<link type="text/css" rel="stylesheet" href="css/FacturaquaCommonModule.css"/>
		<link type="text/css" rel="stylesheet" href="css/FacturaquaDesktopModule.css"/>
	...
	<body >
		...
		<div id="progressIcon">
			<table align="center">
				<tr>
					<td>
						<img height="35px" src="../images/logo_bajo_relieve_transp.png" />
					</td>
				</tr>
				<tr>
					<td>
						<img height="100px" src="../images/progressBarLoaderBig.gif" />
					</td>
				</tr>
			</table>
		</div>
