package com.imotion.facturaqua.front.business.desktop.client;


import com.imotion.facturaqua.front.business.client.BusinessBaseAppController;
import com.imotion.facturaqua.front.business.client.presenter.controller.BusinessControllerDisplay;
import com.imotion.facturaqua.front.business.client.presenter.controller.BusinessControllerPresenter;
import com.imotion.facturaqua.front.business.client.presenter.dashboard.BusinessDesktopDashboardPresenter;
import com.imotion.facturaqua.front.business.client.presenter.login.BusinessLoginPresenter;
import com.imotion.facturaqua.front.business.client.presenter.signup.BusinessDesktopSignUpPresenter;
import com.imotion.facturaqua.front.business.desktop.client.flow.BusinessDesktopAppFlowController;
import com.imotion.facturaqua.front.business.desktop.client.view.controller.BusinessDesktopControllerScreenView;
import com.imotion.facturaqua.front.business.desktop.client.view.dashboard.BusinessDesktopDashboardScreenView;
import com.imotion.facturaqua.front.business.desktop.client.view.info.BusinessDesktopInfoScreenView;
import com.imotion.facturaqua.front.business.desktop.client.view.login.BusinessDesktopLoginScreenView;
import com.imotion.facturaqua.front.business.desktop.client.view.signup.BusinessDesktopSignUpScreenView;
