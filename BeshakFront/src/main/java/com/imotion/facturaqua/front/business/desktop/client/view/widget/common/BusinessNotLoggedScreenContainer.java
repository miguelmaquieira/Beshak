package com.imotion.facturaqua.front.business.desktop.client.view.widget.common;
...
import com.imotion.facturaqua.front.business.client.view.controller.I18NBusinessControllerTexts;
...
public class BusinessNotLoggedScreenContainer extends AEGWTCompositePanel implements HasWidgets {
	...
	private static final I18NBusinessControllerTexts 	BUSINESS_CONTROLLER_TEXTS 	= GWT.create(I18NBusinessControllerTexts.class);
	
	private static NotLoguedScreenContainerUiBinder uiBinder = GWT.create(NotLoguedScreenContainerUiBinder.class);

	interface NotLoguedScreenContainerUiBinder extends UiBinder<Widget, BusinessNotLoggedScreenContainer> {
	}

	@UiField VerticalPanel containerPanel;
	@UiField AEGWTImageAnchor logoAnchor; 
	@UiField HorizontalPanel hpLinksPanel;
	private AEGWTLabel copyRight;
	private Anchor who;
	...
	public BusinessNotLoggedScreenContainer() {
		initWidget(uiBinder.createAndBindUi(this));
		
		setSize("100%", "100%");
		
		hpLinksPanel.getElement().setAttribute("cellpadding", "10");
		copyRight = new AEGWTLabel(BUSINESS_CONTROLLER_TEXTS.label_copyright_text());
