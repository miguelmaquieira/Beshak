package com.imotion.facturaqua.front.business.client.presenter.password;

import com.imotion.facturaqua.front.business.client.BusinessBaseAppControllerConstants;


public interface BusinessForgotPasswordPresenterConstants {

	public static final String NAME = "BusinessForgotPasswordPresenter";
	...
	//MAPPING
	public static final String[] IN_MAPPING = null;
}
