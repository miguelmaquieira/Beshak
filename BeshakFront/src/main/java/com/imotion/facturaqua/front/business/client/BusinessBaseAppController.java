...
import com.imotion.facturaqua.business.FACTBUIServiceConstant;
import com.imotion.facturaqua.front.business.client.presenter.BusinessPresenterBaseConstants;
import com.imotion.facturaqua.front.business.client.presenter.logout.BusinessLogoutPresenter;
...
public abstract class BusinessBaseAppController extends AEGWTLoginAppController {
	...
	public String getBusinessLoginService() {
		return FACTBUIServiceConstant.CTE_SRV_BUSINESS_LOGIN_SERVICE_DEFAULT_IMPL;
	}
