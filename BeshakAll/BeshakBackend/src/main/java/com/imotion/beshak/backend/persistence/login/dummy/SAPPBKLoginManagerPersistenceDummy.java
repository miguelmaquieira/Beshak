...
public class SAPPBKLoginManagerPersistenceDummy extends AEMTLoginPersistenceBase<SAPPBOLoginData, SAPPBOLoginData> implements SAPPBKILoginPersistenceService {

	public SAPPBKLoginManagerPersistenceDummy(AEMFTICoreProxyService proxyCore) {
		super(proxyCore);
	}
	...
	@Override
	public AEMFTIPersistenceModule<SAPPBOLoginData, Long> getPersistenceModule() {
		return null;
	}
	...
	@Override
	public Class<SAPPBOLoginData> getPersistenceClass() {
		// TODO Auto-generated method stub
		return null;
	}
