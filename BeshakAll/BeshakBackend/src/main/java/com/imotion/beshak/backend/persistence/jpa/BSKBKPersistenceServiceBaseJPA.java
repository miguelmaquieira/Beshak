...
public abstract class BSKBKPersistenceServiceBaseJPA<T, Q extends T, Id extends Serializable> extends AEMFTPersistenceServiceBase<T, Q, Id> {
	...
	public AEMFTIPersistenceModule<Q, Id> getPersistenceModule() {
		if (persistenceModule == null) {
			persistenceModule = new BSKBKPersistenceModuleJPA<Q, Id>();
