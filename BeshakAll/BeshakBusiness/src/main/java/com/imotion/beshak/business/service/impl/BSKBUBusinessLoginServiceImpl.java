...
import com.imotion.beshak.business.service.BSKBUIBusinessCommonServiceTrace;
import com.imotion.beshak.business.service.BSKBUIBusinessLoginService;
import com.imotion.beshak.business.service.BSKBUIBusinessLoginServiceConstant;
...
public class BSKBUBusinessLoginServiceImpl extends AEMFTBusinessLoginServiceImpl<BSKBUBusinessWrapperPersistence> implements BSKBUIBusinessLoginService, BSKBUIBusinessLoginServiceConstant {
	...
	public String getName() {
		return BSKBUIBusinessLoginServiceConstant.CTE_BUSINESS_LOGIN_SERVICE_NAME;
	}
	...
	public void traceNullElement(String serviceName, String methodName , String elementType ) {
		...
		getTrace().trace(BSKBUIBusinessCommonServiceTrace.CTE_BUSINESS_SERVICE_NULL_ELEMENT_TRACE, params);
	}
