(function() {
  ...
  function bindTextSelectionEvents() {
    ...
    // feels more instantaneously active
	 document.onmousedown = triggerTextSelectionOut;

    editableNodes.onmousedown = triggerTextSelection;
    editableNodes.onmouseup = function(event) {
      setTimeout(function() {
        triggerTextSelection(event);
      }, 1);
    };
    editableNodes.onkeyup = triggerTextParse;
 ...
 function triggerTextSelectionOut() {
	textMenu.style.visibility='hidden';
}
