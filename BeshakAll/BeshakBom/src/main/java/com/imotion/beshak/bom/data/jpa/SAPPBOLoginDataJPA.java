...
@Entity
public class SAPPBOLoginDataJPA extends SAPPBOLoginData {
	...
	public SAPPBOLoginDataJPA() {
		super();
	}

	public SAPPBOLoginDataJPA(String email, String hash, boolean pendingAccept, int rolType) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SAPPBOLoginDataJPA other = (SAPPBOLoginDataJPA) obj;
		if (userId == null) {
	...
	public String toString() {
		return "SAPPBOLoginDataJPA [userId=" + userId + ", version=" + version
